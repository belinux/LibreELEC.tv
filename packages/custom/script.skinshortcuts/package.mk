...
PKG_URL="https://mirrors.kodi.tv/addons/krypton/script.skinshortcuts/$PKG_NAME-$PKG_VERSION.zip"
...
makeinstall_target() {
  mkdir -p $INSTALL/usr/share/kodi/addons/script.skinshortcuts
    cp -a */ $INSTALL/usr/share/kodi/addons/script.skinshortcuts
}
